...
return [
    ...
    'description' => 'API documentation for LaraChat - A Laravel application with real-time chat capabilities and repository management.',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // 'GET /health', 'admin.*'
                'api/github/webhook', // Exclude GitHub webhook from public documentation
            ],
        ],
    ],
